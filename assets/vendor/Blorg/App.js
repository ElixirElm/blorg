...
var _etaque$elm_route_parser$RouteParser$matchUrl = F3(
	function (path, _p0, maybeRoute) {
		var _p1 = _p0;
		var _p2 = maybeRoute;
		if (_p2.ctor === 'Just') {
			return maybeRoute;
...
var _etaque$elm_route_parser$RouteParser$match = F2(
	function (parsers, url) {
		return A3(
			_elm_lang$core$List$foldl,
			_etaque$elm_route_parser$RouteParser$matchUrl(url),
			_elm_lang$core$Maybe$Nothing,
			parsers);
	});
var _etaque$elm_route_parser$RouteParser$dynParser = F3(
	function (path, aParser, toRoute) {
		return A2(
			_Bogdanp$elm_combine$Combine$map,
			toRoute,
			A2(
				_Bogdanp$elm_combine$Combine_ops['*>'],
				_Bogdanp$elm_combine$Combine$string(path),
				aParser));
	});
var _etaque$elm_route_parser$RouteParser$staticParser = F2(
	function (path, route) {
		return A2(
			_Bogdanp$elm_combine$Combine_ops['<$'],
			route,
...
var _etaque$elm_route_parser$RouteParser$Router = F2(
	function (a, b) {
		return {fromPath: a, toPath: b};
	});
var _etaque$elm_route_parser$RouteParser$router = F2(
	function (routeParsers, pathGenerator) {
		return A2(
			_etaque$elm_route_parser$RouteParser$Router,
			_etaque$elm_route_parser$RouteParser$match(routeParsers),
			pathGenerator);
	});
var _etaque$elm_route_parser$RouteParser$M = function (a) {
	return {ctor: 'M', _0: a};
};
var _etaque$elm_route_parser$RouteParser$rawMatcher = function (matcher) {
	return _etaque$elm_route_parser$RouteParser$M(matcher);
};
var _etaque$elm_route_parser$RouteParser$parserMatcher = function (parser) {
	var matcher = function (path) {
		var _p3 = A2(_Bogdanp$elm_combine$Combine$parse, parser, path);
		if ((_p3.ctor === 'Ok') && (_p3._0.ctor === '_Tuple3')) {
			return _elm_lang$core$Maybe$Just(_p3._0._2);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	};
	return _etaque$elm_route_parser$RouteParser$rawMatcher(matcher);
};
var _etaque$elm_route_parser$RouteParser$static = F2(
	function (route, path) {
		return _etaque$elm_route_parser$RouteParser$parserMatcher(
			A2(_etaque$elm_route_parser$RouteParser$staticParser, path, route));
	});
var _etaque$elm_route_parser$RouteParser$dyn1 = F4(
	function (toRoute, s1, _p4, s2) {
		var _p5 = _p4;
		return _etaque$elm_route_parser$RouteParser$parserMatcher(
			A2(
				_Bogdanp$elm_combine$Combine$andThen,
				_etaque$elm_route_parser$RouteParser$staticParser(s2),
				A3(_etaque$elm_route_parser$RouteParser$dynParser, s1, _p5._0, toRoute)));
	});
var _etaque$elm_route_parser$RouteParser$dyn2 = F6(
	function (toRoute, s1, _p7, s2, _p6, s3) {
		var _p8 = _p7;
		var _p9 = _p6;
		return _etaque$elm_route_parser$RouteParser$parserMatcher(
			A2(
				_Bogdanp$elm_combine$Combine$andThen,
				_etaque$elm_route_parser$RouteParser$staticParser(s3),
				A2(
					_Bogdanp$elm_combine$Combine$andThen,
					A2(_etaque$elm_route_parser$RouteParser$dynParser, s2, _p9._0),
					A3(_etaque$elm_route_parser$RouteParser$dynParser, s1, _p8._0, toRoute))));
	});
var _etaque$elm_route_parser$RouteParser$dyn3 = F8(
	function (toRoute, s1, _p12, s2, _p11, s3, _p10, s4) {
		var _p13 = _p12;
		var _p14 = _p11;
		var _p15 = _p10;
		return _etaque$elm_route_parser$RouteParser$parserMatcher(
			A2(
				_Bogdanp$elm_combine$Combine$andThen,
				_etaque$elm_route_parser$RouteParser$staticParser(s4),
				A2(
					_Bogdanp$elm_combine$Combine$andThen,
					A2(_etaque$elm_route_parser$RouteParser$dynParser, s3, _p15._0),
					A2(
						_Bogdanp$elm_combine$Combine$andThen,
						A2(_etaque$elm_route_parser$RouteParser$dynParser, s2, _p14._0),
						A3(_etaque$elm_route_parser$RouteParser$dynParser, s1, _p13._0, toRoute)))));
	});
var _etaque$elm_route_parser$RouteParser$mapMatcher = F2(
	function (mapper, _p16) {
		var _p17 = _p16;
		...
		return _etaque$elm_route_parser$RouteParser$M(newMatcher);
	});
var _etaque$elm_route_parser$RouteParser$mapMatchers = F2(
	function (wrapper, matchers) {
		return A2(
			_elm_lang$core$List$map,
			_etaque$elm_route_parser$RouteParser$mapMatcher(wrapper),
			matchers);
	});
var _etaque$elm_route_parser$RouteParser$P = function (a) {
	return {ctor: 'P', _0: a};
};
var _etaque$elm_route_parser$RouteParser$int = _etaque$elm_route_parser$RouteParser$P(_Bogdanp$elm_combine$Combine_Num$int);
var _etaque$elm_route_parser$RouteParser$string = _etaque$elm_route_parser$RouteParser$P(_etaque$elm_route_parser$RouteParser_Parser$stringParam);
var _etaque$elm_route_parser$RouteParser$customParam = _etaque$elm_route_parser$RouteParser$P;

var _ElixirElm$blorg$Blorg_Config_AppRoutes$toPath = function (route) {
	var _p0 = route;
	switch (_p0.ctor) {
		case 'NotInitialized':
			return '/404';
...
var _ElixirElm$blorg$Blorg_Config_AppRoutes$Article = function (a) {
	return {ctor: 'Article', _0: a};
};
var _ElixirElm$blorg$Blorg_Config_AppRoutes$ArticleList = {ctor: 'ArticleList'};
var _ElixirElm$blorg$Blorg_Config_AppRoutes$doRedirects = function (route) {
	var _p1 = route;
	if (_p1.ctor === 'Home') {
		return _ElixirElm$blorg$Blorg_Config_AppRoutes$ArticleList;
	} else {
		return route;
	}
};
var _ElixirElm$blorg$Blorg_Config_AppRoutes$Home = {ctor: 'Home'};
var _ElixirElm$blorg$Blorg_Config_AppRoutes$matchers = {
	ctor: '::',
	_0: A2(_etaque$elm_route_parser$RouteParser$static, _ElixirElm$blorg$Blorg_Config_AppRoutes$Home, ''),
	_1: {
		ctor: '::',
		_0: A2(_etaque$elm_route_parser$RouteParser$static, _ElixirElm$blorg$Blorg_Config_AppRoutes$Home, '/'),
		_1: {
			ctor: '::',
			_0: A2(_etaque$elm_route_parser$RouteParser$static, _ElixirElm$blorg$Blorg_Config_AppRoutes$ArticleList, '/articles'),
			_1: {
				ctor: '::',
				_0: A2(_etaque$elm_route_parser$RouteParser$static, _ElixirElm$blorg$Blorg_Config_AppRoutes$ArticleList, '/articles/'),
				_1: {
					ctor: '::',
					_0: A4(_etaque$elm_route_parser$RouteParser$dyn1, _ElixirElm$blorg$Blorg_Config_AppRoutes$Article, '/articles/', _etaque$elm_route_parser$RouteParser$int, ''),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _ElixirElm$blorg$Blorg_Config_AppRoutes$toRoute = function (location) {
	return A2(_etaque$elm_route_parser$RouteParser$match, _ElixirElm$blorg$Blorg_Config_AppRoutes$matchers, location);
};
var _ElixirElm$blorg$Blorg_Config_AppRoutes$NotFound = {ctor: 'NotFound'};
var _ElixirElm$blorg$Blorg_Config_AppRoutes$NotInitialized = {ctor: 'NotInitialized'};
...
var _ElixirElm$blorg$RELM_Lib_DecoderExts$decodeNullOr = function (decoder) {
	return _elm_lang$core$Json_Decode$oneOf(
		{
			ctor: '::',
			_0: _elm_lang$core$Json_Decode$null(_elm_lang$core$Maybe$Nothing),
...
var _ElixirElm$blorg$RELM_Lib_DecoderExts$customDecoder = F2(
...
var _ElixirElm$blorg$RELM_Lib_DecoderExts$decodeDate = A2(_ElixirElm$blorg$RELM_Lib_DecoderExts$customDecoder, _elm_lang$core$Json_Decode$string, _elm_lang$core$Date$fromString);

var _ElixirElm$blorg$Blorg_Schema_Article$toRoute = function (article) {
	return _ElixirElm$blorg$Blorg_Config_AppRoutes$Article(article.id);
};
var _ElixirElm$blorg$Blorg_Schema_Article$Article = F3(
	function (a, b, c) {
		return {id: a, title: b, body: c};
	});
var _ElixirElm$blorg$Blorg_Schema_Article$decodeArticle = A3(
	...
	A3(
		...
		A3(
			...
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_ElixirElm$blorg$Blorg_Schema_Article$Article))));
var _ElixirElm$blorg$Blorg_Schema_Article$decodeArticleData = A2(
	...
	_ElixirElm$blorg$Blorg_Schema_Article$decodeArticle);
var _ElixirElm$blorg$Blorg_Schema_Article$decodeArticleList = _elm_lang$core$Json_Decode$list(_ElixirElm$blorg$Blorg_Schema_Article$decodeArticle);
var _ElixirElm$blorg$Blorg_Schema_Article$decodeArticleListData = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
	...
	_ElixirElm$blorg$Blorg_Schema_Article$decodeArticleList);

var _ElixirElm$blorg$RELM_Lib_Event$discardAndLogEvent = F3(
	function (update, msg, model) {
		var _p0 = A2(update, msg, model);
		var model1 = _p0._0;
		var cmd1 = _p0._1;
		var event1 = _p0._2;
		var _p1 = A2(_elm_lang$core$Debug$log, 'event', event1);
		return {ctor: '_Tuple2', _0: model1, _1: cmd1};
	});
var _ElixirElm$blorg$RELM_Lib_Event$withoutEvent = F3(
	function (update, msg, model) {
		var _p2 = A2(update, msg, model);
		var model1 = _p2._0;
		var cmd1 = _p2._1;
		return {ctor: '_Tuple2', _0: model1, _1: cmd1};
	});
var _ElixirElm$blorg$RELM_Lib_Event$withEvent = function (_p3) {
	var _p4 = _p3;
	return {ctor: '_Tuple3', _0: _p4._0, _1: _p4._1, _2: _elm_lang$core$Maybe$Nothing};
};

var _ElixirElm$blorg$Blorg_Config_App$forReactor = false;
var _ElixirElm$blorg$Blorg_Config_App$apiHost = function () {
	var _p0 = _ElixirElm$blorg$Blorg_Config_App$forReactor;
	if (_p0 === true) {
...
var _ElixirElm$blorg$Blorg_Layout_Page$title = function (t) {
	return A3(
		_debois$elm_mdl$Material_Options$styled,
...
var _ElixirElm$blorg$Blorg_Layout_Page$scheme = function (main) {
	var _p0 = _ElixirElm$blorg$Blorg_Config_App$forReactor;
	if (_p0 === true) {
		return A3(_debois$elm_mdl$Material_Scheme$topWithScheme, _debois$elm_mdl$Material_Color$LightBlue, _debois$elm_mdl$Material_Color$Red, main);
	} else {
		return main;
	}
};
var _ElixirElm$blorg$Blorg_Layout_Page$layout = F3(
	function (mdlAction, mdl, main) {
		var header = {
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Blorg'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
		...
		return _ElixirElm$blorg$Blorg_Layout_Page$scheme(
			A4(
...
var _ElixirElm$blorg$Blorg_Layout_Page$boxed = {
	ctor: '::',
...
var _ElixirElm$blorg$Blorg_Layout_Page$body = F2(
	function (t, content) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			_ElixirElm$blorg$Blorg_Layout_Page$boxed,
			{
				ctor: '::',
				_0: _ElixirElm$blorg$Blorg_Layout_Page$title(t),
				_1: content
			});
	});
...
var _ElixirElm$blorg$Blorg_Component_ArticleListView$State = F2(
	function (a, b) {
		return {articleList: a, mdl: b};
	});
var _ElixirElm$blorg$Blorg_Component_ArticleListView$initialState = function (articleList) {
	return A2(_ElixirElm$blorg$Blorg_Component_ArticleListView$State, articleList, _debois$elm_mdl$Material$model);
};
var _ElixirElm$blorg$Blorg_Component_ArticleListView$init = function (articleList) {
	return {
		ctor: '_Tuple2',
		_0: _ElixirElm$blorg$Blorg_Component_ArticleListView$initialState(articleList),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _ElixirElm$blorg$Blorg_Component_ArticleListView$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _ElixirElm$blorg$Blorg_Component_ArticleListView$ClickArticle = function (a) {
	return {ctor: 'ClickArticle', _0: a};
};
var _ElixirElm$blorg$Blorg_Component_ArticleListView$viewItem = F3(
	function (mdl, index, item) {
		return A2(
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A5(
							...
							_ElixirElm$blorg$Blorg_Component_ArticleListView$Mdl,
							{
								ctor: '::',
								_0: index,
								_1: {
							...
							mdl,
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(
									_ElixirElm$blorg$Blorg_Component_ArticleListView$ClickArticle(item)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _ElixirElm$blorg$Blorg_Component_ArticleListView$view = function (state) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				A2(
					_elm_lang$core$List$indexedMap,
					_ElixirElm$blorg$Blorg_Component_ArticleListView$viewItem(state.mdl),
					state.articleList)),
			_1: {
				ctor: '::',
				_0: A5(
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'bottom', '1em'),
										_1: {
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Options$css, 'right', '1em'),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _ElixirElm$blorg$Blorg_Component_ArticleListView$GoToArticle = function (a) {
	return {ctor: 'GoToArticle', _0: a};
};
var _ElixirElm$blorg$Blorg_Component_ArticleListView$update = F2(
	function (action, state) {
		var _p0 = action;
		if (_p0.ctor === 'ClickArticle') {
			var _p2 = _p0._0;
			var _p1 = A2(_elm_lang$core$Debug$log, 'ClickArticle', _p2);
			return {
				ctor: '_Tuple3',
				_0: state,
				_1: _elm_lang$core$Platform_Cmd$none,
				_2: _elm_lang$core$Maybe$Just(
					_ElixirElm$blorg$Blorg_Component_ArticleListView$GoToArticle(_p2))
			};
		} else {
			return _ElixirElm$blorg$RELM_Lib_Event$withEvent(
				A3(_debois$elm_mdl$Material$update, _ElixirElm$blorg$Blorg_Component_ArticleListView$Mdl, _p0._0, state));
		}
	});

var _ElixirElm$blorg$Blorg_Component_ArticleView$view = function (state) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _ElixirElm$blorg$Blorg_Layout_Page$title(state.article.title),
			_1: {
				ctor: '::',
				_0: A3(
					_debois$elm_mdl$Material_Options$styled,
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(state.article.body),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _ElixirElm$blorg$Blorg_Component_ArticleView$State = F2(
	function (a, b) {
		return {article: a, mdl: b};
	});
var _ElixirElm$blorg$Blorg_Component_ArticleView$initialState = function (article) {
	return A2(_ElixirElm$blorg$Blorg_Component_ArticleView$State, article, _debois$elm_mdl$Material$model);
};
var _ElixirElm$blorg$Blorg_Component_ArticleView$init = function (article) {
	return {
		ctor: '_Tuple2',
		_0: _ElixirElm$blorg$Blorg_Component_ArticleView$initialState(article),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _ElixirElm$blorg$Blorg_Component_ArticleView$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _ElixirElm$blorg$Blorg_Component_ArticleView$update = F2(
	function (action, state) {
		var _p0 = action;
		return _ElixirElm$blorg$RELM_Lib_Event$withEvent(
			A3(_debois$elm_mdl$Material$update, _ElixirElm$blorg$Blorg_Component_ArticleView$Mdl, _p0._0, state));
	});

var _ElixirElm$blorg$Blorg_Route_NotFoundRoute$view = function (state) {
	return A2(
		_ElixirElm$blorg$Blorg_Layout_Page$body,
		'Not Found',
		{ctor: '[]'});
};
var _ElixirElm$blorg$Blorg_Route_NotFoundRoute$update = F2(
	function (action, state) {
		return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
	});
var _ElixirElm$blorg$Blorg_Route_NotFoundRoute$initialState = {ctor: '_Tuple0'};
var _ElixirElm$blorg$Blorg_Route_NotFoundRoute$init = {ctor: '_Tuple2', _0: _ElixirElm$blorg$Blorg_Route_NotFoundRoute$initialState, _1: _elm_lang$core$Platform_Cmd$none};
...
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$viewSpinner = _debois$elm_mdl$Material_Spinner$spinner(
	{
		ctor: '::',
		_0: _debois$elm_mdl$Material_Spinner$active(true),
		_1: {ctor: '[]'}
	});
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$updateOnEventFrom_ArticleView = F2(
	function (event, state) {
		return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
	});
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$get_ArticleView = function (state) {
	var _p0 = state.onDemand;
	if (_p0.ctor === 'ArticleViewState') {
		return _elm_lang$core$Maybe$Just(_p0._0);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$State = F3(
	function (a, b, c) {
		return {responseForArticle: a, onDemand: b, mdl: c};
	});
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$ArticleViewState = function (a) {
	return {ctor: 'ArticleViewState', _0: a};
};
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$set_ArticleView = F2(
	function (value, state) {
		var _p1 = state.onDemand;
		if (_p1.ctor === 'ArticleViewState') {
			return _elm_lang$core$Native_Utils.update(
				state,
				{
					onDemand: _ElixirElm$blorg$Blorg_Route_ArticleRoute$ArticleViewState(value)
				});
		} else {
			return state;
		}
	});
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$NoData = {ctor: 'NoData'};
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$initialState = A3(_ElixirElm$blorg$Blorg_Route_ArticleRoute$State, _krisajenkins$remotedata$RemoteData$NotAsked, _ElixirElm$blorg$Blorg_Route_ArticleRoute$NoData, _debois$elm_mdl$Material$model);
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$ArticleView = function (a) {
	return {ctor: 'ArticleView', _0: a};
};
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$update_ArticleView = F2(
	function (act, state) {
		var maybeOldValue = _ElixirElm$blorg$Blorg_Route_ArticleRoute$get_ArticleView(state);
		var _p2 = function () {
			var _p3 = maybeOldValue;
			if (_p3.ctor === 'Nothing') {
				return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
			} else {
				var _p4 = A2(_ElixirElm$blorg$Blorg_Component_ArticleView$update, act, _p3._0);
				var newValue = _p4._0;
				var newCmd = _p4._1;
				var wantedEvent = _p4._2;
				return {
					ctor: '_Tuple3',
					_0: A2(_ElixirElm$blorg$Blorg_Route_ArticleRoute$set_ArticleView, newValue, state),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ElixirElm$blorg$Blorg_Route_ArticleRoute$ArticleView, newCmd),
					_2: wantedEvent
				};
			}
		}();
		var myState = _p2._0;
		var myCmd = _p2._1;
		var maybeNewEvent = _p2._2;
		var _p5 = maybeNewEvent;
		if (_p5.ctor === 'Nothing') {
			return {ctor: '_Tuple3', _0: myState, _1: myCmd, _2: _elm_lang$core$Maybe$Nothing};
		} else {
			var _p6 = A2(_ElixirElm$blorg$Blorg_Route_ArticleRoute$updateOnEventFrom_ArticleView, _p5._0, myState);
			var afterState = _p6._0;
			var afterCmd = _p6._1;
			var afterEvent = _p6._2;
			return {
				ctor: '_Tuple3',
				_0: afterState,
				_1: _elm_lang$core$Platform_Cmd$batch(
...
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$update = F2(
	function (action, state) {
		var _p7 = action;
		switch (_p7.ctor) {
			case 'ResponseForArticle':
				var _p9 = _p7._0;
				var _p8 = _p9;
				if (_p8.ctor === 'Success') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							state,
							{
								onDemand: _ElixirElm$blorg$Blorg_Route_ArticleRoute$ArticleViewState(
									_ElixirElm$blorg$Blorg_Component_ArticleView$initialState(_p8._0)),
								responseForArticle: _p9
							}),
						_1: _elm_lang$core$Platform_Cmd$none,
			...
			case 'ArticleView':
				return A2(_ElixirElm$blorg$Blorg_Route_ArticleRoute$update_ArticleView, _p7._0, state);
			default:
				return _ElixirElm$blorg$RELM_Lib_Event$withEvent(
					A3(_debois$elm_mdl$Material$update, _ElixirElm$blorg$Blorg_Route_ArticleRoute$Mdl, _p7._0, state));
		}
	});
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$view = function (state) {
	return A2(
		_ElixirElm$blorg$Blorg_Layout_Page$body,
		'',
		{
			ctor: '::',
			_0: function () {
				var _p10 = state.responseForArticle;
				switch (_p10.ctor) {
					case 'NotAsked':
						return _ElixirElm$blorg$Blorg_Route_ArticleRoute$viewSpinner;
					case 'Loading':
						return _ElixirElm$blorg$Blorg_Route_ArticleRoute$viewSpinner;
					case 'Failure':
						return A2(
					...
					default:
						var maybeSub = _ElixirElm$blorg$Blorg_Route_ArticleRoute$get_ArticleView(state);
						var _p11 = maybeSub;
						if (_p11.ctor === 'Nothing') {
							...
							return A2(
								_elm_lang$html$Html$map,
								_ElixirElm$blorg$Blorg_Route_ArticleRoute$ArticleView,
								_ElixirElm$blorg$Blorg_Component_ArticleView$view(_p11._0));
						}
				}
			}(),
			_1: {ctor: '[]'}
...
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$ResponseForArticle = function (a) {
	return {ctor: 'ResponseForArticle', _0: a};
};
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$loadArticle = function (id) {
	var url = A2(
		_elm_lang$core$Debug$log,
		'ArticleRoute, Loading',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_ElixirElm$blorg$Blorg_Config_App$apiHost,
			A2(
				_elm_lang$core$Basics_ops['++'],
				'/api/v1/articles/',
	...
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_ElixirElm$blorg$Blorg_Route_ArticleRoute$ResponseForArticle,
		_krisajenkins$remotedata$RemoteData$sendRequest(
			A2(_elm_lang$http$Http$get, url, _ElixirElm$blorg$Blorg_Schema_Article$decodeArticleData)));
};
var _ElixirElm$blorg$Blorg_Route_ArticleRoute$init = function (id) {
	return {
		ctor: '_Tuple2',
		_0: _ElixirElm$blorg$Blorg_Route_ArticleRoute$initialState,
		_1: _ElixirElm$blorg$Blorg_Route_ArticleRoute$loadArticle(id)
	};
};

var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$viewSpinner = _debois$elm_mdl$Material_Spinner$spinner(
	{
		ctor: '::',
		_0: _debois$elm_mdl$Material_Spinner$active(true),
		_1: {ctor: '[]'}
	});
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$get_ArticleListView = function (state) {
	var _p0 = state.onDemand;
	if (_p0.ctor === 'ArticleListViewState') {
		return _elm_lang$core$Maybe$Just(_p0._0);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$State = F3(
	function (a, b, c) {
		return {responseForArticleList: a, onDemand: b, mdl: c};
	});
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$ArticleListViewState = function (a) {
	return {ctor: 'ArticleListViewState', _0: a};
};
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$set_ArticleListView = F2(
	function (value, state) {
		var _p1 = state.onDemand;
		if (_p1.ctor === 'ArticleListViewState') {
			return _elm_lang$core$Native_Utils.update(
				state,
				{
					onDemand: _ElixirElm$blorg$Blorg_Route_ArticleListRoute$ArticleListViewState(value)
				});
		} else {
			return state;
		}
	});
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$NoData = {ctor: 'NoData'};
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$initialState = A3(_ElixirElm$blorg$Blorg_Route_ArticleListRoute$State, _krisajenkins$remotedata$RemoteData$NotAsked, _ElixirElm$blorg$Blorg_Route_ArticleListRoute$NoData, _debois$elm_mdl$Material$model);
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$ArticleListView = function (a) {
	return {ctor: 'ArticleListView', _0: a};
};
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$view = function (state) {
	return A2(
		_ElixirElm$blorg$Blorg_Layout_Page$body,
		'',
		{
			ctor: '::',
			_0: function () {
				var _p2 = state.responseForArticleList;
				switch (_p2.ctor) {
					case 'NotAsked':
						return _ElixirElm$blorg$Blorg_Route_ArticleListRoute$viewSpinner;
					case 'Loading':
						return _ElixirElm$blorg$Blorg_Route_ArticleListRoute$viewSpinner;
					case 'Failure':
						return A2(
					...
					default:
						var maybeSub = _ElixirElm$blorg$Blorg_Route_ArticleListRoute$get_ArticleListView(state);
						var _p3 = maybeSub;
						if (_p3.ctor === 'Nothing') {
							return _elm_lang$html$Html$text('');
						} else {
							return A2(
								_elm_lang$html$Html$map,
								_ElixirElm$blorg$Blorg_Route_ArticleListRoute$ArticleListView,
								_ElixirElm$blorg$Blorg_Component_ArticleListView$view(_p3._0));
						}
				}
			}(),
			_1: {ctor: '[]'}
...
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$ResponseForArticleList = function (a) {
	return {ctor: 'ResponseForArticleList', _0: a};
};
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$loadArticleList = function () {
	var url = A2(
		_elm_lang$core$Debug$log,
		'ArticleListRoute, Loading',
		A2(_elm_lang$core$Basics_ops['++'], _ElixirElm$blorg$Blorg_Config_App$apiHost, '/api/v1/articles/'));
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_ElixirElm$blorg$Blorg_Route_ArticleListRoute$ResponseForArticleList,
		_krisajenkins$remotedata$RemoteData$sendRequest(
			A2(_elm_lang$http$Http$get, url, _ElixirElm$blorg$Blorg_Schema_Article$decodeArticleListData)));
}();
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$init = {ctor: '_Tuple2', _0: _ElixirElm$blorg$Blorg_Route_ArticleListRoute$initialState, _1: _ElixirElm$blorg$Blorg_Route_ArticleListRoute$loadArticleList};
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$GoToArticle = function (a) {
	return {ctor: 'GoToArticle', _0: a};
};
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$updateOnEventFrom_ArticleListView = F2(
	function (event, state) {
		var _p4 = event;
		return {
			ctor: '_Tuple3',
			...
			_1: _elm_lang$core$Platform_Cmd$none,
			_2: _elm_lang$core$Maybe$Just(
				_ElixirElm$blorg$Blorg_Route_ArticleListRoute$GoToArticle(_p4._0))
		};
	});
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$update_ArticleListView = F2(
	function (act, state) {
		var maybeOldValue = _ElixirElm$blorg$Blorg_Route_ArticleListRoute$get_ArticleListView(state);
		var _p5 = function () {
			var _p6 = maybeOldValue;
			if (_p6.ctor === 'Nothing') {
				return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
			} else {
				var _p7 = A2(_ElixirElm$blorg$Blorg_Component_ArticleListView$update, act, _p6._0);
				var newValue = _p7._0;
				var newCmd = _p7._1;
				var wantedEvent = _p7._2;
				return {
					ctor: '_Tuple3',
					_0: A2(_ElixirElm$blorg$Blorg_Route_ArticleListRoute$set_ArticleListView, newValue, state),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ElixirElm$blorg$Blorg_Route_ArticleListRoute$ArticleListView, newCmd),
					_2: wantedEvent
				};
			}
		}();
		var myState = _p5._0;
		var myCmd = _p5._1;
		var maybeNewEvent = _p5._2;
		var _p8 = maybeNewEvent;
		if (_p8.ctor === 'Nothing') {
			return {ctor: '_Tuple3', _0: myState, _1: myCmd, _2: _elm_lang$core$Maybe$Nothing};
		} else {
			var _p9 = A2(_ElixirElm$blorg$Blorg_Route_ArticleListRoute$updateOnEventFrom_ArticleListView, _p8._0, myState);
			var afterState = _p9._0;
			var afterCmd = _p9._1;
			var afterEvent = _p9._2;
			return {
				ctor: '_Tuple3',
				_0: afterState,
				_1: _elm_lang$core$Platform_Cmd$batch(
...
var _ElixirElm$blorg$Blorg_Route_ArticleListRoute$update = F2(
	function (action, state) {
		var _p10 = action;
		switch (_p10.ctor) {
			case 'ResponseForArticleList':
				var _p12 = _p10._0;
				var _p11 = _p12;
				if (_p11.ctor === 'Success') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							state,
							{
								onDemand: _ElixirElm$blorg$Blorg_Route_ArticleListRoute$ArticleListViewState(
									_ElixirElm$blorg$Blorg_Component_ArticleListView$initialState(_p11._0)),
								responseForArticleList: _p12
							}),
						_1: _elm_lang$core$Platform_Cmd$none,
						_2: _elm_lang$core$Maybe$Nothing
					};
			...
			case 'ArticleListView':
				return A2(_ElixirElm$blorg$Blorg_Route_ArticleListRoute$update_ArticleListView, _p10._0, state);
			default:
				return _ElixirElm$blorg$RELM_Lib_Event$withEvent(
					A3(_debois$elm_mdl$Material$update, _ElixirElm$blorg$Blorg_Route_ArticleListRoute$Mdl, _p10._0, state));
		}
	});

var _ElixirElm$blorg$Blorg_Config_AppRouter$updateOnEventFrom_ArticleRoute = F2(
	function (event, state) {
		return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
	});
var _ElixirElm$blorg$Blorg_Config_AppRouter$updateOnEventFrom_NotFoundRoute = F2(
	function (event, state) {
		return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
	});
var _ElixirElm$blorg$Blorg_Config_AppRouter$toRoute = function (state) {
	return state.route;
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$get_ArticleListRoute = function (state) {
	var _p0 = state.onDemand;
	if (_p0.ctor === 'ArticleListRouteState') {
		return _elm_lang$core$Maybe$Just(_p0._0);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$get_ArticleRoute = function (state) {
	var _p1 = state.onDemand;
	if (_p1.ctor === 'ArticleRouteState') {
		return _elm_lang$core$Maybe$Just(_p1._0);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$get_NotFoundRoute = function (state) {
	var _p2 = state.onDemand;
	if (_p2.ctor === 'NotFoundRouteState') {
		return _elm_lang$core$Maybe$Just(_p2._0);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$State = F3(
	function (a, b, c) {
		return {route: a, onDemand: b, mdl: c};
	});
var _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleListRouteState = function (a) {
	return {ctor: 'ArticleListRouteState', _0: a};
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$set_ArticleListRoute = F2(
	function (value, state) {
		var _p3 = state.onDemand;
		if (_p3.ctor === 'ArticleListRouteState') {
			return _elm_lang$core$Native_Utils.update(
				state,
				{
					onDemand: _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleListRouteState(value)
				});
		} else {
			return state;
		}
	});
var _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleRouteState = function (a) {
	return {ctor: 'ArticleRouteState', _0: a};
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$set_ArticleRoute = F2(
	function (value, state) {
		var _p4 = state.onDemand;
		if (_p4.ctor === 'ArticleRouteState') {
			return _elm_lang$core$Native_Utils.update(
				state,
				{
					onDemand: _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleRouteState(value)
				});
		} else {
			return state;
		}
	});
var _ElixirElm$blorg$Blorg_Config_AppRouter$NotFoundRouteState = function (a) {
	return {ctor: 'NotFoundRouteState', _0: a};
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$set_NotFoundRoute = F2(
	function (value, state) {
		var _p5 = state.onDemand;
		if (_p5.ctor === 'NotFoundRouteState') {
			return _elm_lang$core$Native_Utils.update(
				state,
				{
					onDemand: _ElixirElm$blorg$Blorg_Config_AppRouter$NotFoundRouteState(value)
				});
		} else {
			return state;
		}
	});
var _ElixirElm$blorg$Blorg_Config_AppRouter$NoRoute = {ctor: 'NoRoute'};
var _ElixirElm$blorg$Blorg_Config_AppRouter$init = function () {
	var _p6 = _ElixirElm$blorg$Blorg_Route_NotFoundRoute$init;
	var notFoundRoute = _p6._0;
	var notFoundCmd = _p6._1;
	return {
		ctor: '_Tuple2',
		_0: {route: _ElixirElm$blorg$Blorg_Config_AppRoutes$NotInitialized, onDemand: _ElixirElm$blorg$Blorg_Config_AppRouter$NoRoute, mdl: _debois$elm_mdl$Material$model},
		_1: _elm_lang$core$Platform_Cmd$none
	};
}();
var _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleListRoute = function (a) {
	return {ctor: 'ArticleListRoute', _0: a};
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleRoute = function (a) {
	return {ctor: 'ArticleRoute', _0: a};
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$update_ArticleRoute = F2(
	function (act, state) {
		var maybeOldValue = _ElixirElm$blorg$Blorg_Config_AppRouter$get_ArticleRoute(state);
		var _p7 = function () {
			var _p8 = maybeOldValue;
			if (_p8.ctor === 'Nothing') {
				return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
			} else {
				var _p9 = A2(_ElixirElm$blorg$Blorg_Route_ArticleRoute$update, act, _p8._0);
				var newValue = _p9._0;
				var newCmd = _p9._1;
				var wantedEvent = _p9._2;
				return {
					ctor: '_Tuple3',
					_0: A2(_ElixirElm$blorg$Blorg_Config_AppRouter$set_ArticleRoute, newValue, state),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleRoute, newCmd),
					_2: wantedEvent
				};
			}
		}();
		var myState = _p7._0;
		var myCmd = _p7._1;
		var maybeNewEvent = _p7._2;
		var _p10 = maybeNewEvent;
		if (_p10.ctor === 'Nothing') {
			return {ctor: '_Tuple3', _0: myState, _1: myCmd, _2: _elm_lang$core$Maybe$Nothing};
		} else {
			var _p11 = A2(_ElixirElm$blorg$Blorg_Config_AppRouter$updateOnEventFrom_ArticleRoute, _p10._0, myState);
			var afterState = _p11._0;
			var afterCmd = _p11._1;
			var afterEvent = _p11._2;
			return {
				ctor: '_Tuple3',
				_0: afterState,
				_1: _elm_lang$core$Platform_Cmd$batch(
...
var _ElixirElm$blorg$Blorg_Config_AppRouter$NotFoundRoute = function (a) {
	return {ctor: 'NotFoundRoute', _0: a};
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$gotoRoute = F2(
	function (route, state) {
		...
		switch (_p13.ctor) {
			...
			case 'Home':
				return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
			case 'NotFound':
				var _p14 = _ElixirElm$blorg$Blorg_Route_NotFoundRoute$init;
				var subState = _p14._0;
				var subCmd = _p14._1;
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Native_Utils.update(
						state,
						{
							onDemand: _ElixirElm$blorg$Blorg_Config_AppRouter$NotFoundRouteState(subState),
							route: route
						}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ElixirElm$blorg$Blorg_Config_AppRouter$NotFoundRoute, subCmd),
					_2: _elm_lang$core$Maybe$Nothing
				};
			case 'Article':
				var _p15 = _ElixirElm$blorg$Blorg_Route_ArticleRoute$init(_p13._0);
				var subState = _p15._0;
				var subCmd = _p15._1;
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Native_Utils.update(
						state,
						{
							onDemand: _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleRouteState(subState),
							route: route
						}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleRoute, subCmd),
					_2: _elm_lang$core$Maybe$Nothing
				};
			default:
				var _p16 = _ElixirElm$blorg$Blorg_Route_ArticleListRoute$init;
				var subState = _p16._0;
				var subCmd = _p16._1;
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Native_Utils.update(
						state,
						{
							onDemand: _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleListRouteState(subState),
							route: route
						}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleListRoute, subCmd),
					_2: _elm_lang$core$Maybe$Nothing
				};
		}
	});
var _ElixirElm$blorg$Blorg_Config_AppRouter$updateOnEventFrom_ArticleListRoute = F2(
	function (event, state) {
		var _p17 = event;
		return A2(
			_ElixirElm$blorg$Blorg_Config_AppRouter$gotoRoute,
			_ElixirElm$blorg$Blorg_Schema_Article$toRoute(_p17._0),
			state);
	});
var _ElixirElm$blorg$Blorg_Config_AppRouter$update_ArticleListRoute = F2(
	function (act, state) {
		var maybeOldValue = _ElixirElm$blorg$Blorg_Config_AppRouter$get_ArticleListRoute(state);
		var _p18 = function () {
			var _p19 = maybeOldValue;
			if (_p19.ctor === 'Nothing') {
				return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
			} else {
				var _p20 = A2(_ElixirElm$blorg$Blorg_Route_ArticleListRoute$update, act, _p19._0);
				var newValue = _p20._0;
				var newCmd = _p20._1;
				var wantedEvent = _p20._2;
				return {
					ctor: '_Tuple3',
					_0: A2(_ElixirElm$blorg$Blorg_Config_AppRouter$set_ArticleListRoute, newValue, state),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ElixirElm$blorg$Blorg_Config_AppRouter$ArticleListRoute, newCmd),
					_2: wantedEvent
				};
			}
		}();
		var myState = _p18._0;
		var myCmd = _p18._1;
		var maybeNewEvent = _p18._2;
		var _p21 = maybeNewEvent;
		if (_p21.ctor === 'Nothing') {
			return {ctor: '_Tuple3', _0: myState, _1: myCmd, _2: _elm_lang$core$Maybe$Nothing};
		} else {
			var _p22 = A2(_ElixirElm$blorg$Blorg_Config_AppRouter$updateOnEventFrom_ArticleListRoute, _p21._0, myState);
			var afterState = _p22._0;
			var afterCmd = _p22._1;
			var afterEvent = _p22._2;
			return {
				ctor: '_Tuple3',
				_0: afterState,
				_1: _elm_lang$core$Platform_Cmd$batch(
...
var _ElixirElm$blorg$Blorg_Config_AppRouter$update_NotFoundRoute = F2(
	function (act, state) {
		var maybeOldValue = _ElixirElm$blorg$Blorg_Config_AppRouter$get_NotFoundRoute(state);
		var _p23 = function () {
			var _p24 = maybeOldValue;
			if (_p24.ctor === 'Nothing') {
				return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
			} else {
				var _p25 = A2(_ElixirElm$blorg$Blorg_Route_NotFoundRoute$update, act, _p24._0);
				var newValue = _p25._0;
				var newCmd = _p25._1;
				var wantedEvent = _p25._2;
				return {
					ctor: '_Tuple3',
					_0: A2(_ElixirElm$blorg$Blorg_Config_AppRouter$set_NotFoundRoute, newValue, state),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ElixirElm$blorg$Blorg_Config_AppRouter$NotFoundRoute, newCmd),
					_2: wantedEvent
				};
			}
		}();
		var myState = _p23._0;
		var myCmd = _p23._1;
		var maybeNewEvent = _p23._2;
		var _p26 = maybeNewEvent;
		if (_p26.ctor === 'Nothing') {
			return {ctor: '_Tuple3', _0: myState, _1: myCmd, _2: _elm_lang$core$Maybe$Nothing};
		} else {
			var _p27 = A2(_ElixirElm$blorg$Blorg_Config_AppRouter$updateOnEventFrom_NotFoundRoute, _p26._0, myState);
			var afterState = _p27._0;
			var afterCmd = _p27._1;
			var afterEvent = _p27._2;
			return {
				ctor: '_Tuple3',
				_0: afterState,
				_1: _elm_lang$core$Platform_Cmd$batch(
...
var _ElixirElm$blorg$Blorg_Config_AppRouter$viewRoute = function (state) {
	var _p28 = state.route;
	switch (_p28.ctor) {
		case 'NotInitialized':
			return _elm_lang$html$Html$text('NotInitialized');
		case 'Home':
			return _elm_lang$html$Html$text('Why Home?');
		case 'NotFound':
			var maybeSub = _ElixirElm$blorg$Blorg_Config_AppRouter$get_NotFoundRoute(state);
			var _p29 = maybeSub;
			if (_p29.ctor === 'Nothing') {
				...
				return A2(
					_elm_lang$html$Html$map,
					_ElixirElm$blorg$Blorg_Config_AppRouter$NotFoundRoute,
					_ElixirElm$blorg$Blorg_Route_NotFoundRoute$view(_p29._0));
			}
		case 'Article':
			var maybeSub = _ElixirElm$blorg$Blorg_Config_AppRouter$get_ArticleRoute(state);
			var _p30 = maybeSub;
			if (_p30.ctor === 'Nothing') {
				...
				return A2(
					_elm_lang$html$Html$map,
					_ElixirElm$blorg$Blorg_Config_AppRouter$ArticleRoute,
					_ElixirElm$blorg$Blorg_Route_ArticleRoute$view(_p30._0));
			}
		default:
			var maybeSub = _ElixirElm$blorg$Blorg_Config_AppRouter$get_ArticleListRoute(state);
			var _p31 = maybeSub;
			if (_p31.ctor === 'Nothing') {
				...
				return A2(
					_elm_lang$html$Html$map,
					_ElixirElm$blorg$Blorg_Config_AppRouter$ArticleListRoute,
					_ElixirElm$blorg$Blorg_Route_ArticleListRoute$view(_p31._0));
			}
	}
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$GoTo = function (a) {
	return {ctor: 'GoTo', _0: a};
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _ElixirElm$blorg$Blorg_Config_AppRouter$update = F2(
	function (action, state) {
		var _p32 = action;
		switch (_p32.ctor) {
			case 'Mdl':
				return _ElixirElm$blorg$RELM_Lib_Event$withEvent(
					A3(_debois$elm_mdl$Material$update, _ElixirElm$blorg$Blorg_Config_AppRouter$Mdl, _p32._0, state));
			case 'NotFoundRoute':
				return A2(_ElixirElm$blorg$Blorg_Config_AppRouter$update_NotFoundRoute, _p32._0, state);
			case 'ArticleRoute':
				return A2(_ElixirElm$blorg$Blorg_Config_AppRouter$update_ArticleRoute, _p32._0, state);
			case 'ArticleListRoute':
				return A2(_ElixirElm$blorg$Blorg_Config_AppRouter$update_ArticleListRoute, _p32._0, state);
			default:
				return A2(_ElixirElm$blorg$Blorg_Config_AppRouter$gotoRoute, _p32._0, state);
		}
	});
var _ElixirElm$blorg$Blorg_Config_AppRouter$view = function (state) {
	return A3(
		_ElixirElm$blorg$Blorg_Layout_Page$layout,
		_ElixirElm$blorg$Blorg_Config_AppRouter$Mdl,
		state.mdl,
		{
			ctor: '::',
			_0: _ElixirElm$blorg$Blorg_Config_AppRouter$viewRoute(state),
			_1: {ctor: '[]'}
		});
};
...
var _ElixirElm$blorg$Main$delta2url = F2(
	function (state1, state2) {
		return (!_elm_lang$core$Native_Utils.eq(
			_ElixirElm$blorg$Blorg_Config_AppRouter$toRoute(state1.appRouter),
			_ElixirElm$blorg$Blorg_Config_AppRouter$toRoute(state2.appRouter))) ? _elm_lang$core$Maybe$Just(
			{
				entry: _rgrempel$elm_route_url$RouteUrl$NewEntry,
				url: A2(
					_elm_lang$core$Basics_ops['++'],
					'#',
					_ElixirElm$blorg$Blorg_Config_AppRoutes$toPath(
						_ElixirElm$blorg$Blorg_Config_AppRouter$toRoute(state2.appRouter)))
			}) : _elm_lang$core$Maybe$Nothing;
	});
var _ElixirElm$blorg$Main$updateOnEventFrom_AppRouter = F2(
	function (event, state) {
		return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
	});
var _ElixirElm$blorg$Main$set_AppRouter = F2(
	function (value, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{appRouter: value});
	});
var _ElixirElm$blorg$Main$get_AppRouter = function (state) {
	return _elm_lang$core$Maybe$Just(state.appRouter);
};
var _ElixirElm$blorg$Main$State = function (a) {
	return {appRouter: a};
};
var _ElixirElm$blorg$Main$AppRouter = function (a) {
	return {ctor: 'AppRouter', _0: a};
};
var _ElixirElm$blorg$Main$init = function () {
	var _p0 = _ElixirElm$blorg$Blorg_Config_AppRouter$init;
	var res = _p0._0;
	var resCmd = _p0._1;
	return {
		ctor: '_Tuple2',
		_0: _ElixirElm$blorg$Main$State(res),
		_1: A2(_elm_lang$core$Platform_Cmd$map, _ElixirElm$blorg$Main$AppRouter, resCmd)
	};
}();
var _ElixirElm$blorg$Main$update_AppRouter = F2(
	function (act, state) {
		var maybeOldValue = _ElixirElm$blorg$Main$get_AppRouter(state);
		var _p1 = function () {
			var _p2 = maybeOldValue;
			if (_p2.ctor === 'Nothing') {
				return {ctor: '_Tuple3', _0: state, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing};
			} else {
				var _p3 = A2(_ElixirElm$blorg$Blorg_Config_AppRouter$update, act, _p2._0);
				var newValue = _p3._0;
				var newCmd = _p3._1;
				var wantedEvent = _p3._2;
				return {
					ctor: '_Tuple3',
					_0: A2(_ElixirElm$blorg$Main$set_AppRouter, newValue, state),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ElixirElm$blorg$Main$AppRouter, newCmd),
					_2: wantedEvent
				};
			}
		}();
		var myState = _p1._0;
		var myCmd = _p1._1;
		var maybeNewEvent = _p1._2;
		var _p4 = maybeNewEvent;
		if (_p4.ctor === 'Nothing') {
			return {ctor: '_Tuple3', _0: myState, _1: myCmd, _2: _elm_lang$core$Maybe$Nothing};
		} else {
			var _p5 = A2(_ElixirElm$blorg$Main$updateOnEventFrom_AppRouter, _p4._0, myState);
			var afterState = _p5._0;
			var afterCmd = _p5._1;
			var afterEvent = _p5._2;
			return {
				ctor: '_Tuple3',
				_0: afterState,
				_1: _elm_lang$core$Platform_Cmd$batch(
...
var _ElixirElm$blorg$Main$update = F2(
	function (msg, state) {
		var _p6 = msg;
		return A2(_ElixirElm$blorg$Main$update_AppRouter, _p6._0, state);
	});
var _ElixirElm$blorg$Main$view = function (state) {
	var maybeSub = _ElixirElm$blorg$Main$get_AppRouter(state);
	var _p7 = maybeSub;
	if (_p7.ctor === 'Nothing') {
		return _elm_lang$html$Html$text('');
	} else {
		return A2(
			_elm_lang$html$Html$map,
			_ElixirElm$blorg$Main$AppRouter,
			_ElixirElm$blorg$Blorg_Config_AppRouter$view(_p7._0));
	}
};
var _ElixirElm$blorg$Main$location2messages = function (location) {
	var relativeLink = A2(_elm_lang$core$String$dropLeft, 1, location.hash);
	var maybeRoute = _ElixirElm$blorg$Blorg_Config_AppRoutes$toRoute(relativeLink);
	var _p8 = A2(_elm_lang$core$Debug$log, 'App, maybeRoute ', maybeRoute);
	var _p9 = A2(_elm_lang$core$Debug$log, 'App, relativeLink', relativeLink);
	var _p10 = maybeRoute;
	if (_p10.ctor === 'Nothing') {
		return {
			ctor: '::',
			_0: _ElixirElm$blorg$Main$AppRouter(
				_ElixirElm$blorg$Blorg_Config_AppRouter$GoTo(_ElixirElm$blorg$Blorg_Config_AppRoutes$NotFound)),
			_1: {ctor: '[]'}
		};
	} else {
		return {
			ctor: '::',
			_0: _ElixirElm$blorg$Main$AppRouter(
				_ElixirElm$blorg$Blorg_Config_AppRouter$GoTo(
					_ElixirElm$blorg$Blorg_Config_AppRoutes$doRedirects(_p10._0))),
			_1: {ctor: '[]'}
		};
	}
};
var _ElixirElm$blorg$Main$main = _rgrempel$elm_route_url$RouteUrl$program(
	{
		delta2url: _ElixirElm$blorg$Main$delta2url,
		location2messages: _ElixirElm$blorg$Main$location2messages,
		init: _ElixirElm$blorg$Main$init,
		view: _ElixirElm$blorg$Main$view,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
		update: _ElixirElm$blorg$RELM_Lib_Event$withoutEvent(_ElixirElm$blorg$Main$update)
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ElixirElm$blorg$Main$main !== 'undefined') {
    _ElixirElm$blorg$Main$main(Elm['Main'], 'Main', undefined);
}
